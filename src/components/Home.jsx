                ...
                <ul className="communication-list">
                  <li className="communication-item">
                    <a href="https://instagram.com/sweets_by_elli?igshid=YzcxN2Q2NzY0OA=="
                       target={'_blank'} className="communication-link">
                      <img className={'social-link'} src="/images/insta.jpg" alt=""/>
                    </a>
                  </li>
                  <li className="communication-item">
                    <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Хочу+сделать+заказ" target={'_blank'} className="communication-link">
                  ...
                  <li className="communication-item">
                    <div className="communication-container">
                      ...
                      <img className={'mail-class'} src="/images/mail.jpg" alt=""/>
                ...
                <div className="hero-container">
                  ...
                  <ul className="hero__text-list">
                    <li className="hero__text-item"><h1 className="hero__title-text">Кондитерская
                      студия <br/> <b>«ELLI SWEETS»</b></h1></li>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Бенто-торт" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Торт+лев" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Свадебный+торт" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Торт+с+зайкой" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Торт-бомба" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Медовик+в+виде+цифры" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="catalog__card">
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <p className="catalog__text">Разноцветный крем, с бисквитной основой</p>
                          <div className="price-container">
                            <p className="catalog__price">1700₽/кг</p>
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовала+Начинка+вишня-шоколад+в+разрезе" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовал+Торт+в+стиле+Гарри+Поттера" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="card-inner">
                        ...
                        <div className="catalog__text-container">
                          ...
                          <div className="price-container">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=79933189710&text=Здравствуйте!+Меня+заинтересовало+Муссовое+серце" target={'_blank'} className="catalog__btn">Купить сейчас</a>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <section className="cakes-s">
            ...
            <div className="arrow-div">
              <a href="https://instagram.com/sweets_by_elli?igshid=YzcxN2Q2NzY0OA==" target={'_blank'} className="cakes__btn"
                 ...
                 onMouseLeave={handleMouseLeave}>Вся коллекция<span className={'cakes-btn-arrow'}>
                ...
                <ul className="footer__list">
                  <li className="footer__item">
                    <div className="footer__link-container">
                      ...
                      <a href="mailto:zakazocake@gmail.com" target={'_blank'} className="footer-link">zakazocake@gmail.com
                        | <b>«ELLI SWEETS»</b></a>
                    </div>
                  </li>
                  <li className="footer__item">
